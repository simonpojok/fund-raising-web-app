...
export class CreateCampaignService {
  ...
  getSupportedPaymentMethods(): Observable<GetPaymentMethodsResponseInterface> {
    return this.http.get<GetPaymentMethodsResponseInterface>(`${environment.apiUrl}/payment-methods/`);
  }
